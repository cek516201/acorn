    ...
    return (
        <>
            ...
            <Form.Group className="mb-3" controlId="image">
                ...
                <Form.Control /*style={{ display: "none" }}*/ ref={imageInput} type="file" name="image" accept="image/*" multiple />
            </Form.Group>
            <div onClick={() => { imageInput.current.click() }} ref={dropZone} onDragOver={(e) => e.preventDefault()}
