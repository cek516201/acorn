...
public class MemberFrame01 extends JFrame implements ActionListener {
	// 필요한 필드 정의하기
	...
	// 생성자
	public MemberFrame01(String title) {
		super(title);
	...
	public static void main(String[] args) {
		MemberFrame01 f = new MemberFrame01("회원정보 관리");
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 * - 중요!! java 에서 문자열은 내용이 같아도 참조값이 다른 경우가 있다. 따라서 문자열의 내용이 같은지 비교 할때는 동등 비교 연산자
		 * == 를 사용하면 안된다. 문자열의 내용을 비교할때는 .equals() 메소드를 활용해야 한다.
		 */
