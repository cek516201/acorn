...
<body>
	<jsp:include page="/include/navbar.jsp">
		<jsp:param value="member" name="currentPage"/>
	</jsp:include>
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="${pageContext.request.contextPath}/member/delete.jsp?num=<%= member.getNum() %>">
					...
					<td>
						<a href="${pageContext.request.contextPath}/member/updateform.jsp?num=<%= member.getNum() %>">
