...
<body>
	<div class="container" id="app">
		<h1 class="my-3">비밀 번호 수정 페이지</h1>
		<form action="${pageContext.request.contextPath}/user/private/pwd_update.jsp" method="post" id="myForm">
			<div class="my-3">
			...
			<button class="btn btn-success mx-1" type="submit" v-bind:disabled="!isPwdValid || !isNewPwdValid">수정하기</button>
			<button class="btn btn-danger mx-1" type="reset">리셋</button>		
		</form>
	</div>
