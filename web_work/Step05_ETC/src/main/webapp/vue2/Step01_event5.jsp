...
<body>
	<div class="container" id="app">
		...
		<form action="${pageContext.request.contextPath}/vue2/send.jsp" method="post" @submit="onSubmit">
			<input type="text" name="msg" placeholder="메시지 입력"/>
			<button type="submit">전송</button>
		</form>
		
		<h1>form submit 이벤트 처리2</h1>
		<!-- @submit.prevent : 폼 제출을 자동으로 막아줌 -->
		<form action="${pageContext.request.contextPath}/vue2/send.jsp" method="post" @submit.prevent="onSubmit2">
			<input type="text" name="msg" placeholder="메시지 입력"/>
			<button type="submit">전송</button>
		</form>
	</div>
